...
// u32 is unsigned int defined in utils
...
draw_rect_in_pixels(int x0, int y0, int x1, int y1, u32 color) {
	...
	// if not clamped, when resized below height of rect, the game crashes
...
draw_rect(float x, float y, float half_size_x, float half_size_y, u32 color) {
	...
	// this makes the rect change size when screen y is changed
	// does nothing when horizontal window is changed
